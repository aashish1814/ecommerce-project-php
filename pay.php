...
$conn->close(); 
 ...
 $result = $amount;
 $uniqueProductId = "20";
 $uniqueUrl = "http://localhost/ecommerce/shop.php";
...
{
    $verifyAmount = $amount*100 ; // get amount from database and multiply by 100
...
<div class="khalticontainer">
    ...
    <center>
        <div><img src="images/khalti.png" alt="khalti" width="300"></div>
    </center>
    <?php
    if ($token == "") {
